...
if __name__ == '__main__':
    ...
    if reset_memory:
        f1 = open('manipulation_results/first_approach/k-' + str(k) + '/results_with_' + str(number_of_manipulation) + '_manipulations_and_' + str(num_image_query) + '_images_forward_reset_k' + str(k) + '.txt', 'w')
        f2 = open('manipulation_results/first_approach/k-' + str(k) + '/results_with_' + str(number_of_manipulation) + '_manipulations_and_' + str(num_image_query) + '_images_backward_reset_k' + str(k) + '.txt', 'w')
    else:
        f1 = open('manipulation_results/first_approach/k-' + str(k) + '/results_with_' + str(number_of_manipulation) + '_manipulations_and_' + str(num_image_query) + '_images_forward_k' + str(k) + '.txt', 'w')
        f2 = open('manipulation_results/first_approach/k-' + str(k) + '/results_with_' + str(number_of_manipulation) + '_manipulations_and_' + str(num_image_query) + '_images_backward_k' + str(k) + '.txt', 'w')
    num_attributes = 0
    categories = []
    ...
    for z in range(0, num_image_query):
        ...
        with torch.no_grad():
            ...
            # todo check
            final_weights_memory.append(deepcopy(memory.Memory.weight.data).cuda())
    ...
    for z in range(0, num_image_query):
        ...
        if reset_memory:
            ...
            memory.Memory.weight.data = final_weights_memory[z]
