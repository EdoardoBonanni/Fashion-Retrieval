...
if __name__ == '__main__':
    ...
    f1 = open('manipulation_results/method 2/k-' + str(k) + '/results_with_' + str(number_of_manipulation) + '_manipulations_and_' + str(num_image_query) + '_images_retrieval_k' + str(k) + '.txt', 'w')
    num_attributes = 0
    categories = []
    ...
    for z in range(0, num_image_query):
        ...
        with torch.no_grad():
            dis_feat, _ = model_ntm_feature.model_feature(img_query)
