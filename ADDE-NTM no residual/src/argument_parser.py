...
def add_base_args(parser):  # common arguments for all CLIs
    ...
    parser.add_argument('--load_pretrained_extractor', type=str,
                        default="models/Shopping100k/encoder/extractor_best_loss_200.pkl",
                        help='Load pretrained weights of disentangled representation learner')
    # parser.add_argument('--load_pretrained_extractor', type=str,
    #                     default="models/Shopping100k/manip/extractor_best_loss_100.pkl",
    #                     help='Load pretrained weights of disentangled representation learner')
    parser.add_argument('--load_pretrained_memory', type=str,
                        default="models/Shopping100k/manip/memory_best_loss_100.pkl",
                        help='Load pretrained weights of memory block')
    # parser.add_argument('--load_pretrained_memory', type=str,
    #                     default="models/Shopping100k/memory_best.pkl",
    #                     help='Load pretrained weights of memory block')
...
def add_train_args(parser):
    ...
    # parser.add_argument('--load_init_mem', type=str, default="models/Shopping100k/initialized_memory_block/init_mem.npy",
    #                     help='Load initial memory block generated from init_mem.py')
    parser.add_argument('--load_init_mem', type=str, default="models/Shopping100k/initialized_memory_block/init_mem_200.npy",
                        help='Load initial memory block generated from init_mem.py')
...
def add_eval_args(parser):
    ...
    parser.add_argument('--save_matrix', action='store_true',
                        help='Save the gallery feature and fused feature', default=True)
