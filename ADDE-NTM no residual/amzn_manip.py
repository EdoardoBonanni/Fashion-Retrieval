...
def train(train_loader, model_ntm_feature, optimizer, args, train):
    ...
    list_index_triplets = random.sample(list_index_triplets, 50)
    ...
    return avg_total_loss / len(list_index_triplets)
...
def eval(gallery_loader, query_loader, model_ntm_feature, optimizer, args, file_root, eval):
    ...
    # list_index_query = random.sample(list_index_query, 50)
