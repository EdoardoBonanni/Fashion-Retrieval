...
if __name__ == '__main__':
    ...
    f1 = open('manipulation_results/method 1/k-' + str(k) + '/results_with_' + str(number_of_manipulation) + '_manipulations_and_' + str(num_image_query) + '_images_retrieval_k' + str(k) + '.txt', 'w')
    num_attributes = 0
    categories = []
